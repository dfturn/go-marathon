...
// PodTmpEnvSecret holds the secret values deserialized from the environment variables field
type PodTmpEnvSecret struct {
	Secret string `json:"secret,omitempty"`
}

// PodTmpSecret holds the deserialized secrets field in a Marathon pod configuration
type PodTmpSecret struct {
